"""Internal (service-role-only) endpoints for platform-side callers.

Currently exposes GET /api/internal/mau-count, which an hourly MAU-drain
job polls per project to read the trailing-30d MAU counts it bills against
